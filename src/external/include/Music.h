...
@property (copy, readonly) NSString *downloaderAccount;  // the account of the person who downloaded this track
...
@property (copy, readonly) NSString *purchaserAccount;  // the account of the person who purchased this track
